...
### M2 — 抽牌 / 能量 / 疲劳 ✅
- 实现卡组抽牌、首回合抽 5 之后抽 2、手牌上限 10 跳过、能量回合重置为 4、疲劳（伤害固定 2 / 生成攻击卡攻击力 +1，敌我独立）。
- **DoD**：M2 相关单测全绿（见 §2）。
...
### M6 — UI 与动画 ✅
- React 组件：敌我角色区、9 格仆从区、手牌、中线（能量/回合箭头/结束回合）、指向箭头选目标。
